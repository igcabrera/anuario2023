...
const JuegosInflables = () => {
  ...
  return (
    <div>
      ...
      <div className="p-6">
        <img
          src="/juegos-inflables/portada.webp"
      ...
      <div className="masonry sm:masonry-sm md:masonry-md mx-8 mb-12">
        {[...Array(15)].map((_, index) => (
          <div
            key={index}
            onClick={() => openModal(`/juegos-inflables/${index + 1}.webp`)}
            className="rounded-lg bg-gray-500 p-4 break-inside cursor-pointer"
          >
            <img
              src={`/juegos-inflables/${index + 1}.webp`}
              alt=""
...
export default JuegosInflables;
