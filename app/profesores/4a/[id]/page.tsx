...
import alumnoData from "@/lib/data/semblanzasA2023.json";
import profesData from "@/lib/data/BaseProfesA.json"; // Suponiendo que tienes un archivo con los datos de los alumnos
import {
  ReactCompareSlider,
...
export default function AlumnoDetail() {
  ...
  const alumno = profesData.find((alumno) => alumno.id === parseInt(id));
