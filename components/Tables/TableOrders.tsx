...
const packageData: Orders[] = [
  {
    orderId: "1b2trt456",
    email: "rosa@melano.com",
    precio: 400000,
    FechaSolicitud: "Febrero 13,2023",
    estado: "Pagado",
  },
  {
    orderId: "3b2trt456",
  ...
  },
  {
    ...
    email: "rosa@melano.com",
    precio: 500000,
    FechaSolicitud: "Diciembre 13,2023",
    estado: "Pagado",
  },
];
              ...
              {packageData.map((orderItem, key) => (
                <tr key={key}>
                  ...
                  <td className="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                    ...
                    <p className="text-sm">${orderItem.precio}</p>
                  </td>
                  <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                    <p className="text-black dark:text-white">
                      {orderItem.FechaSolicitud}
                    </p>
                  </td>
                  <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                    <p
